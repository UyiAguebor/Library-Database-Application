...
public class BooksDatabaseServer {
    ...
    public BooksDatabaseServer(){
        ...
        try {
            ...
            //TO BE COMPLETED
            InetAddress JIP = InetAddress.getByName(theIPAddress.toString());
            serverSocket = new ServerSocket(thePort,0,JIP);
    ...
    public void executeServiceLoop()
    {
        ...
        try {
            ...
            while (true) {
                ...
                BooksDatabaseService tmp = new BooksDatabaseService(aSocket);
